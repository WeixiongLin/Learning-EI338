 ...
 * <tr><td>2020-12-20 <td>1.0     <td>WeixiongLin     <td>内容
 * </table>
 */
...
/**
 * @brief Check if OS os in safe state: There exists a process that can be granted resources it need and run.
 * @return int 
 */
int is_safe() {
...
/**
 * @brief Banker's Algorithm: request resources.
 *        If the requested resources are available, OS grant them to the customer.
 *        And check new state with is_safe().
...
/**
 * @brief Banker's Algorithm: release resources
 * @param  customer         the target customer
...
/**
 * @brief Regularization of request input
 */
...
/**
 * @brief Regularization of release information.
 */
...
/**
 * @brief Overall resources information.
 */
...
/**
 * @brief Check input.
 * @param  argc             Customer ID
 * @param  argv             Resources needed of customer.
 * @param  resources_file   File includes maximum needed resources of processes.
 * @return int 
 */
